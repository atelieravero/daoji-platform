              ...
              <div>
                ...
                <div className="mt-2 relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
